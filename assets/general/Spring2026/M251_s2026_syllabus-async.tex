...
to do any task on any particular day with the exception of the Midterms (2), the Derivative Proficiency and Derivative Proficiency Retake, and the
...
\begin{itemize}
\item The ALEKS quiz: this is a proctored version of the UAF Math Placement test, which also measures your initial prerequisite knowledge. It counts towards your total Quiz grade and must be completed within the first three weeks.
...
\hline \hline
ALEKS Quiz & Monday September 1 -- Friday September 12 & 2 hours\\
\hline
Midterm I & Thursday September 25 or Friday September 26 & 1.5 hours \\
\hline
Derivative Proficiency & Thurs Oct 16 or Fri Oct 17 & 1 hour\\
\hline
Derivative Proficiency Retake (Optional) & Mon Oct 27 -- Friday Oct 31 & 1 hour\\
\hline
Midterm II & Thursday November 13 or Friday November 14 & 1.5 hours \\
\hline
%Integral Proficiency& Wed Dec 7 or Thurs Dec 8 & 30 minutes\\
%\hline
Final Exam & Tuesday Dec 19 -- Thursday December 11& 2 hours \\
\hline
\end{tabular}
\end{center}
...
A proficiency is an assessment covering a routine mechanical skill.  In this course we have two of these, one for derivatives and one for integrals, on the dates listed in the online schedule. Note that the course webpage contains all previous proficiencies (with solutions) so a student can know in advance what these are like and has lots of opportunity for practice. Proficiencies will be graded on a binary scale for each problem (no partial credit). The Derivative Proficiency is a proctored assessment, while the Integral Proficiency will be unproctored.
