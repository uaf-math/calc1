...
\heading{Class Time}
In the synchronous sections, there are \textbf{five} hours of class meetings every week, one hour daily.  Tuesday is a recitation hour with a Teaching Assistant, while the remaining days are a lecture with your instructor.  Classes will meet over Zoom.  Classes will include some traditional lectures as well as group work, along with videos to watch outside of class.
...
Calculus collects many of the best tools in mathematics.  It has applications in all the sciences, in engineering, and it meets General Education Requirements, in particular
...
\item You may request an automatic 5-day extension on each WebAssign assignment.% though you will only be allowed to earn back half the remaining points. 
...
\item You may choose to turn off your video when you are not speaking (especially if it slows down the connection).
\item If possible, please turn on your video when you are speaking.
\item Please post a clear headshot of yourself to your Zoom profile, so that your instructor and classmates can see who they're interacting with.
\item Please use the Zoom ``raise hand'' feature to ask questions.  
\item Please use Zoom reactions as quick check-ins. Note that upgrading to the latest version of Zoom gives a wider variety of possible reactions!
...
\item Please try to participate and pay attention in class and don't multitask by checking email or twitter or whatever.
