...
\rhead{\large\sf\textbf{DRAFT Fall 2019 Syllabus DRAFT}}
...
\heading{Quizzes}
There will be weekly quizzes that will cover the material taught in the classes since the previous quiz; specific topics can be found in the schedule on the course website.  Quizzes are equally weighted, and are given under testing conditions; books, notes, and calculators are not allowed.  Performance on the quizzes is a better indicator of exam performance, and how well you are learning the course material, than homework which may be done with the input of tutors/friends/internet/etc.
...
\newpage
\begin{center}{\large\sf{\textbf{Addendum for the In-Person Sections}}}\end{center}
...
Here is what you will do in the first two weeks of class:

\begin{clist}
\item Enroll in the Fall 2019 Calculus I Cohort of ALEKS PPL.
\item Complete an initial placement test (approx 1-2 hours) by \textbf{{\color{blue}Wednesday, August 28 at 11:59pm}}.
\item Complete 90\% of the ALEKS pie \: OR \: spend 10 hours in Learning Mode by \textbf{{\color{blue} Monday, September 2 at 11:59pm}}; this will count as one of your homework grades.
\item Complete a proctored ALEKS PPL test (approx 1-2 hours) on  \textbf{{\color{blue}Tuesday, September 3}}, which will count as your first \textbf{two} quiz grades.
\end{clist}
...
There will not be a standard recitation in Week 2.  Rather, you will schedule a time slot to take your PPL test at the UAF library.

\heading{Midterms}
{\color{red}{Midterms are given in the evenings in one of two time slots: (A) 5pm-6pm or (B) 6pm-7pm. Note that students choosing time slot A will be required to stay in the classroom until 6pm.}}

A student who cannot attend either time slot \emph{must notify his/her instructor at least one week in advance} in order to make other arrangements.
