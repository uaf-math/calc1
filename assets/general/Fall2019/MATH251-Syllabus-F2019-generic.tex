...
\rhead{\large\sf\textbf{Fall 2019 Syllabus}}
...
\item Work every problem on every homework assignment (written or online) \textbf{independently}. Check your answer and get help if needed before it is due.
\item Take the review week seriously. Start practicing these habits on Day 1 of the semester.
\item Treat all graded work as \emph{formative} assessments. (This is fancy education-speak for learning from your mistakes.) This requires that you \emph{rework} (not ``look over") all missed problems and then try another similar problem. 
\item If a student attends every class and has solid prerequisite knowledge, this course should require roughly 10 hours of work outside of class. If a student skips class and/or has weak prerequisite knowledge, this course should require more. \textbf{Schedule} these Calculus Study Hours the same way you schedule class meetings or work hours.
\end{enumerate}
