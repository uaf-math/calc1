...
{\emph{Instructor}}& Stefano Fochesatto \cr
%\strut & \cr
{\emph{Email}}&gsfochesatto@alaska.edu \cr
%\strut & \cr
{\emph{Office}}&Chapman 308 \cr
{\emph{Phone}}&907-888-3950 (cell). 
\cr
...
All the materials for this course is available online linked either from Canvas or from the public Calculus I webpage. The course is organized as weekly modules in Canvas. Although this is
an online course, \emph{it is not a self-paced course}. In order to help students stay on track and not get too far behind, there are weekly
...
The beginning of the course is devoted to prerequisite review. Consequently, the first homework and first quiz of the semester will feel different from the rest. The \textbf{first homework} consists of problems from Precalculus and can be found on the public webpage \href{https://uaf-math251.github.io/newhomework.html}{here}. It is turned in using Gradescope which is accessed from Canvas and is due on \textbf{Monday January 23}. The \textbf{first quiz} is an assessment in ALEKS. This assessment must be proctored. Information about this assessment can be found at the ALEKS info link on the public webpage \href{https://uaf-math251.github.io/week1-ALEKS.html}{here}.


\heading{Tentative Schedule}
A day-to-day schedule is posted on the course website on the sidebar listed as \href{https://docs.google.com/spreadsheets/d/e/2PACX-1vRItLK-cGDMPCaQrIaB0sH4ybNUOSB5kmHbCHU5vqSmW_70GGrUtqazkMqiRGxa51-_rO-rIQUwUZWx/pubhtml?gid=0&single=true}{Schedule (asynchronous section)}. This schedule mirrors the tasks for a typical
...
%The beginning of the course is devoted to prerequisite review. Consequently, the first homework and first quiz of the semester are different from the rest.
%
...
%\begin{clist}
%\item enroll in the {\tt MATH 251 Calculus I - asynchronous, Spring 2023}  Cohort of ALEKS\\
%class code: \textbf{J4FEJ-XAQTK}
%\item complete an initial placement test (approx 1-2 hours) by \textbf{Friday January 27} at 11:59pm \\
...
%\item complete a \emph{proctored} ALEKS assessment (approx 1-2 hours) no later than Friday, September 9 which will count as Quiz 1. You will need to set up proctoring for this yourself; instructions are in Canvas.
%\end{clist}
...
\heading{Homework}
Homework assignments consist of a selection of problems at the end of each section of our textbook. Homework is carefully written (on paper or tablet) and turned in via Gradescope, which may be accessed from Canvas.  Help with scanning homework can be found under \href{https://uaf-math251.github.io/techHelp.html}{Technology Help} on the course webpage. Assignments are due most Mondays and Wednesdays (by 11:59 PM) in advance of the Friday quiz.  Answers to most problems are provided in the back of the book (or linked from the online text). Complete worked solutions to all problems are provided in advance on Canvas. The expectation is that students will work the homework problems, check their answers against the solutions, fix any errors, and upload the revised homework. Thus, your homework will be graded based on \emph{effort} and \emph{completion}. All students should earn 100\% of their homework points!
...
There are a total of \emph{seven proctored assessments} with dates and testing windows listed below, although you can do them with \emph{six} proctoring times. You will set up the proctoring arrangement through eCampus.
...
labeled {\tt Schedule a Testing Appointment} near the middle of the page.
If you live outside the Fairbanks area, you should go to eCampus Exam Services site, \url{https://ecampus.uaf.edu/exam-services/}, and scroll down to the menu of {\tt Popular Exams} where
you will find a yellow bar labeled {\tt UAF eCampus Courses}. Read this section until you see two
options in blue lettering: ``I am in Alaska (but not in Fairbanks)'' and ``I am outside of Alaska.'' Because we are aware that proctoring costs money for students outside of Fairbanks, students can choose to schedule the Quiz 11/ALEKS PPL Round 2 to be taken during the same proctoring session as the Integral Proficiency Test. 
...
\hline \hline
Quiz 1 (proctored ALEKS)& by Fri 27 January & 2 hours\\
\hline
Midterm I & Thurs Feb 16 or Fri Feb 17 & 1.5 hours \\
\hline
Derivative Proficiency & Thurs March 9 or Fri March 10 & 30 minutes\\
\hline
Midterm II & Thurs April 13 or Fri April 14 & 1.5 hours \\
\hline
Integral Proficiency& Thurs April 27 or Fri April 28 & 30 minutes\\
\hline
Final Exam & May 3-5& 2 hours \\
\hline
\end{tabular}
\end{center}
