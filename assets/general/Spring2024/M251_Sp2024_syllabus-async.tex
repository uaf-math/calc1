...
\rhead{\large\sf\textbf{Spring 2024 Syllabus}}
...
\strut & \cr
  ...
  {\emph{Course Materials}}&Canvas (\url{https://canvas.alaska.edu})\cr
...
\heading{Use of AI in this course}
This course requires you to complete various assignments that assess your understanding and application of the course content. You are expected to do your own work. You are not allowed to use any artificial intelligence (AI) tools, such as text generators, paraphrasers, summarizers, or mathematical solvers, to complete any part of your assignments. Using AI tools is considered a form of academic dishonesty and will result in a zero grade for the assignment and possible disciplinary action. If you have any questions about what constitutes acceptable use of AI tools, please consult with the instructor before submitting your work.
