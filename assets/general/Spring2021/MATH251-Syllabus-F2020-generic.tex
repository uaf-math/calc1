...
\heading{Homework}
Homework in this class comes in two varieties: online homework via WebAssign, and FIXME daily homework on paper. %For both types of homework, answers to all of the problems are available in advance. Thus, the purpose of homework is for you to practice on your own. It should be clear that we are providing you with answers so that  you can check your work. Merely copying the solutions is not an effective way to learn mathematics.
...
\subheading{Worksheet Participation}

Most classes will have some form of group work that includes
a worksheet.  Participating on the worksheet is a key part
of learning the course material.  After each class you will upload your completed worksheet to Gradescope.  Grading will be binary: 1 point for evidence of participation, and 0 otherwise.

% Homework is due approximately weekly according to the schedule
...
\begin{clist}
\item Quizzes are equally weighted.  You may bring in a sheet of notes to the quiz, which will be be handed in with your quiz. FIXME: CALCULATOR
...
take your quiz at your regularly scheduled time.  Once you download a  quiz, you will have 40 FIXME 45? minutes to download the quiz from  Gradescope, print the quiz or download it to a device, take the quiz, (photo)scan the quiz, and upload the quiz back to Gradescope. 
