...
{\emph{Instructor}}&Deven Barnett (section 001) \cr
%\strut & \cr
{\emph{Email}}&dcbarnett@alaska.edu \cr
%\strut & \cr
{\emph{Office}}& N/A \cr
...
%&link to Gradescope (to turn in homework, recitations, quizzes)\\
%\href{https://www.uaf.edu/uaf/current/canvas.php}{Canvas}& complete solutions to homework\\
%& your grades\\
%& all other specific course materials: quizzes, check-ins, etc.\\
%\hline
%public Calculus I webpage&practice quizzes, proficiencies, midterms, and final exams\\
%\href{https://uaf-math251.github.io/}{https://uaf-math251.github.io/}&solutions to practice quizzes, proficiencies, midterms, and final exams\\
%& all other general course materials: syllabus, schedule, textbook, videos, etc.\\
%\end{tabular}
%\end{table}
