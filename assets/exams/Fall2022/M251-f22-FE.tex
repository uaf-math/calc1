...
\fancyhead[R]{\ifnum \value{page} > 1\relax\emph{Dec 13, 2022}\fi}
\headheight 15pt
...
\begin{tikzpicture}[scale=0.6]
	\draw [help lines,dashed] (-8.2,-4.2) grid (10.2,10.2);
	\draw [thick, ->] (-8.2,0)--(10.2,0) node[right] {$x$};
	\draw [thick, ->] (0,-4.7)--(0,10.2) node[above]{$g(x)$};
	\end{tikzpicture}
\end{minipage}
\hspace*{-.5in}
...
\draw[help lines, dashed] (-1,-1) grid (11,5);
\draw[style= ultra thick] (0,1) --  (2,5) --(7,0)--(8,0)--(9,-1)--(10,0)--(11,1);
