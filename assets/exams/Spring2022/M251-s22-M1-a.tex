...
\addplot[smooth,ultra thick,<-] coordinates {(-0.66,-4) (0,-3) (2,0)};
\addplot[smooth,ultra thick,->] coordinates {(2,2) (2.5,2.4) (3,3) (3.5,4) (3.9,6) };
\addplot[ultra thick,<-] (4.1,6) parabola bend (5,3)  (5.5,3.5);
\addplot[ultra thick,] (5.5,3.5) parabola bend (6,4)  (7,1);
\addplot[smooth,ultra thick,->] coordinates {(7,1) (7.5,3) (8,4) (8.4,4.4) };
%\node at (-2.5,2.5){\large{$f(x)$}};
\draw[fill=white, thick] (2,2) circle  (1.2 mm);
\draw[fill=black, thick] (2,0) circle  (1.2 mm);
...
\item $\displaystyle{ \lim_{x \to 7^+} f(x) }= \ans$
\bigskip
