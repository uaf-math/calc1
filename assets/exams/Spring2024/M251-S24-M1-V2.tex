...
%\vspace{1in}
 ...
 \[\displaystyle f(x)=\frac{3}{x^2}+6.\] %\[\displaystyle f(x)=\frac{1}{6-x}.\] 
...
\begin{subproblems}
\item Suppose you are told that $P(5) = 2850$. Write a sentence explaining what this means in the context of the problem, and use units in your answer.

\vfill

\item Suppose, in addition, you are told that $P(0) = 200$. What is the average rate of population change between 2018 and 2023? Do a computation to determine this quantity, and write your answer in a sentence, including units.

\vfill

\item The quantity $P'(5) = 850$. Write a sentence explaining what this means in the context of the problem, and include units in your answer.
...
%%%%
&
(b)  \resizebox{\rr\linewidth}{!}{\begin{tikzpicture}
...
(c)  \resizebox{\rr\linewidth}{!}{\begin{tikzpicture}
\begin{axis}[%x=1cm,y=1cm,
yscale=.75,
xscale=.75, %thick, 
my style, 
...
&
%%%%%%%%
(d)  \resizebox{\rr\linewidth}{!}{\begin{tikzpicture}
\begin{axis}[%x=1cm,y=1cm,
yscale=0.5,
xscale=1, %thick, 
my style, 
...
{\setstretch{2}
\[f(x)=\begin{cases} \ds{\frac{4^x}{x+x^2}} & x < 1\\3 & x=1 \\ \ds{\frac{2-2x}{x-x^2}} & x > 1 \end{cases}\]
}
