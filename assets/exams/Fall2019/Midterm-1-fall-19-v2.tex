...
%%%%% f(x) %%%%
\draw [ultra thick] (-6, -2) parabola bend (-4,2)  (-3,1) to  (-2,-1) to (1,-1);
\draw [ultra thick, ->] (1, -2)  parabola bend (2,-2) (3,-1)-- (4,1) -- (6.5,-3);
...
\begin{tikzpicture}
\draw[ thick, <->] (-6.5,0) -- (6.5,0);
\draw[ thick, <->] (0,3.5) -- (0,-3.5);\foreach \i in {-6, -5, -4,-3,-2,-1,1,2,3,4, 5,6}{\draw[ thick] (\i, .1) -- (\i, -.1) node[below]{$\i$};}
\coordinate (0, -.1) node [below left] {0};
\draw[ultra thin] (-6,-3) grid (6,3);
...
\begin{tikzpicture}
\draw[ , <->] (-6.5,0) -- (6.5,0);
\draw[ , <->] (0,3.5) -- (0,-3.5);\foreach \i in {-6, -5, -4,-3,-2,-1,1,2,3,4, 5,6}{\draw[ ] (\i, .1) -- (\i, -.1) node[below]{$\i$};}
\coordinate (0, -.1) node [below left] {0};
