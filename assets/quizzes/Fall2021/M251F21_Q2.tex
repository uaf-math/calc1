...
\problem{11} Let $P(1,4)$ be a point on the graph of $f(x)=\displaystyle{\frac{8x}{x+1}}.$
\begin{subproblems}
...
\begin{tabular}{ccccc}
$\displaystyle{\lim_{x \to2^-} f(x) =5},$&$\displaystyle{\lim_{x \to2^+} f(x) =1,}$&f(2)=3,&
$\displaystyle{\lim_{x \to4} f(x) =3},$&$f(4)=0$\\
\end{tabular}
