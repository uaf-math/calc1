...
\problem{11} Let $P(3,6)$ be a point on the graph of $f(x)=\displaystyle{\frac{8x}{x+1}}.$
\begin{subproblems}
...
\hline
f(x)&5.9487&5.99498&5.99499& 6.00049&6.00498 &6.04870 \\
\hline
$m_{sec}$&0.51282 &0.50123&0.50012&0.49987&0.49875&0.48780\\
\end{tabular}


\vskip 0.5cm
Use the information in the table to estimate the slope of the tangent line to $f(x)$ at the point $P(3,6).$
\vfill
...
%\hline
%f(x)&3.78947&3.97989&3.99799& 4.00199&4.01990 &4.19047 \\
%\hline
%$m_{sec}$&2.10526 &2.01005&2.00100&1.99900&1.99005&1.90476\\
%\end{tabular}
%
%\vskip 0.5cm
%Use the information in the table to estimate the slope of the tangent line to $f(x)$ at the point $P(1,4).$
%\vfill
...
\item Below is a sketch of the graph of $f(x)=\frac{8x}{x+1}.$ Sketch the tangent line to the graph at the point $P.$
...
%%points solid
\addplot[mark=*,only marks] coordinates {(4,-2)(1,0)};
%%points open
\addplot[mark=*,fill=white,only marks] coordinates {(4,2)(1,3)};
%%Curves
\addplot[ultra thick, smooth,<->] coordinates {(-3.2,-5) (-3.9,1) (-6, 2) (-7.5,6)};
\addplot[ultra thick, smooth,<-] coordinates {(-2.5,6.5) (-2,3) (-1,1) (1,0) };
\addplot[ultra thick, smooth] coordinates {(1,3)(4,2) (6,0) (8,1)};
...
\item $\d{\lim_{x \to 8} f(x)=\mblank{.5in}}$
\end{multicols}
\end{subproblems}
...
\begin{tabular}{ccccc}
$\displaystyle{\lim_{x \to2^-} f(x) =3},$&$\displaystyle{\lim_{x \to2^+} f(x) =1,}$&f(2)=1,&
$\displaystyle{\lim_{x \to4} f(x) =2},$&$f(4)=5$\\
\end{tabular}
