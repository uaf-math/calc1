...
\draw [ultra thick, <->] plot [smooth] coordinates {(-1.5,-1) (-1,1)%(-.5,2) 
(0,3)  %(2,2) 
(2.5,1)(3.5,-1)};
...
\item Solve for $x$ in the equation $x^{2}+ 5x = 14$. %(x - 2)(x+7) = x^{2} + 5x  - 14 %$x^2+3x=10.$
...
%      \begin{enumerate}[(a)]
 ...
 \item $y =\sin(x)$ on the interval $[-2\pi, 2\pi]$
...
\node at (1.3, 1.6) {$f(x)$};
\draw[ultra thick] (-1,0) -- (1,-2) -- (2,2); %(-1,0) -- (1,2) -- (2,-2);	
