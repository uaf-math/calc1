...
\vfill
%related rate
\problem{9} The altitude (height, $h$) of a triangle is increasing at at rate of 2 cm/sec while the area of the triangle is decreasing at a rate of 1 $\text{cm}^2$/sec. At what rate is the base, $b$, of the triangle changing with the altitude is 10 cm and the area is 100 $\text{cm}^2$? Include units with your answer.
