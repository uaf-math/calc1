...
\problem{5} Determine the following for the function $f(x) = x^2 - 3x + 2$. \textbf{Simplify} your answers.
\begin{subproblems}
\item $f(4)$ \\
  \vfill
...
\item $f(a-2)$ \\
  \vfill
  \quad \hspace{4in} \underline{\hspace{2in}}
\item Find all values of $x$ such that $f(x) = 12$ \\
  \vfill
  \vfill
  \quad \hspace{4in} \underline{\hspace{2in}}
\end{subproblems}
...
\problem{3} Write the equation of the line that passes through the points $(2,3)$ and $(-4,1)$. \\
  \vfill
  \vfill
  \vfill
  \vfill
...
\problem{4} In the right triangle below, suppose $a=4$ and $c=5$.
...
\end{tikzpicture}
\begin{subproblems}
\item Determine the length of $b$. Show your work.
\vfill
\item Determine the value of $\sin(A)$?
\vfill
\item Determine the value of $\cos(A)$?
\vfill
\item Determine the value of $\tan(A)$?
\vfill
\end{subproblems}

\problem{1} Evaluate $\cos(2\pi/3)$.
...
\begin{center}
			...
			\addplot[-,black,very thick,samples=100,domain=-3:-1]{-(x+2)^2+3};
			\addplot[incl] coordinates {(-3,2)};
			\addplot[incl] coordinates {(-1,2)};
			\addplot[-,black,very thick,samples=100,domain=-1:3]{x-2};
			\addplot[excl,thick] coordinates {(-1,-3)};
			\addplot[incl,thick] coordinates {(3,1)};
			\end{axis}
			\end{tikzpicture}
\end{center}
...
\item State the range of $G$. \hfill \underline{\hspace{2in}} \\
  \vfill
\item State the $y$-intercept of $G$. \hfill \underline{\hspace{2in}} \\
  \vfill
\item State the $x$-intercept(s) of $G$? \hfill \underline{\hspace{2in}} \\
  \vfill
\item Graph the transformed function $G(x-2)+3$ on the axes above. \\
  \vfill
\end{subproblems}
