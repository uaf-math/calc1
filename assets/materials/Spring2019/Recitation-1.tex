...
\begin{quote}
  \begin{enumerate}[(a)]
  \item What units do the slope and the $T$-intecept have?
  \vskip 1cm
...
\aproblem Rewrite the formula for temperature in Problem 1 
in point slope form where the point is determined by 
the the temperature in the year 2000.
\vfill
\newpage
...
Set your graphing calculator and your computer aside.  You should know the 
graphs the following functions in this section by 
heart. In your sketches, clearly indicate any asymptotes,
...
certain simple transformations. Again, set your technology aside
and make these sketches the old-fashioned way.
