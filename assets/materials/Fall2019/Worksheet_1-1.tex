...
\item  Let $f(x) = 3x^2 - x + 2.$ Find and simplify the following expressions. Are (b) and (c) different? 
...
\newpage
\item Write a formula for the top half of the circle with center $(2,0)$ and radius 3.
\vfill

\item Find the domain of each of the following functions. Use interval notation.
\begin{enumerate}
\item $f(x) = \d \frac{1}{x^2 - 16}$
\vfill
