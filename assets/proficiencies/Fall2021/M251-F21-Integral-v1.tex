...
\item $\ds \int_0^{1/2} (4-\cos(\pi x))\; dx$
\vfill

\item $\ds \int (x+3)(2x+1)\; dx$
\vfill

\newpage

\item $\ds \int  xe^{3x^2}\; dx$
\vfill

\item $\ds \int \frac{\cos(x)+1}{\sin(x)+x}\; dx$
\vfill
