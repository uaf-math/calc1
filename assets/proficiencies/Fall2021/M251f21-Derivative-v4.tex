...
%ln
%straight prod
\item   $\ds f(x) = \frac{x \ln(x)}{2}$
\vfill

\item  $\ds f(x) = e^{\pi x+1}+\sqrt{3}\tan(\pi x)$
\vfill

\item  Find $\ds \frac{dy}{dx}$ for $\ds 2x+y=\cos(xy)$. You must solve for $\ds \frac{dy}{dx}$.
\vfill
