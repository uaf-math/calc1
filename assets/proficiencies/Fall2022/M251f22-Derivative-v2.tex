...
\item $\ds k(x)=\arcsin(3x)$
%\textcolor{red}{type: arc trig function with chain rule}

\vfill 
\item $\ds R(\theta)=\left( 2\theta+\sin\left(\frac{\theta}{\pi}\right)\right)^6$
