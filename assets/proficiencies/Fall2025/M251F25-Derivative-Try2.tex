...
\doctitle{Math F251X: Derivative Proficiency Retake}
\docdate{October 24, 2025}
...
\item $\ds f(x) = \frac{5}{3x} + \frac{x^2}{\sqrt{5}}-\frac{\pi^2}{3}$\\
...
\vfill
\item $\ds y=(x^{0.4}+4)^{-1/5}$\\

\vfill

\item $\ds f(t)=\sqrt{t^2+ \cos^2(t)}$\\

\vfill

\newpage
%%%%%page 3 problems
\item $\ds g(x)=\ln(8+\sin(x^4))$\\
...
\item $\ds y=e^{(x^2)} + \sec(5x) $\\

\vfill

%%%%%%page 4 problems
\newpage
\item $\ds f(x)=\sqrt{2} \cos(1+e^{-Nx})$ \hspace{.5in} (Assume $N$ is a fixed positive constant.)

\vfill

\item $\ds j(x)=\frac{x \ln(x) -\sqrt{x}}{x^2}$\\

\vfill

\item Find $\ds \frac{dy}{dx}$ for  $\quad \ds 1+xy= x^3+y^2$\\
