...
\item $\ds f(x)=\frac{1}{3x}+\sqrt{3x}$ \vfill
\item $\ds f(x) = 4x-x^2+2\tan(x)$\vfill
\item $\ds y=\arcsin(x^3)$ \vfill
\newpage
\item $\ds f(x)=a^{\sin(x)}$ where $a$ is a constant, $a >1$\vfill 
\item $\ds f(x)=\sqrt{x+\ln(2x)}$ \vfill
\item $\ds f(x) =\sec\left(\frac{x}{x+1} \right)$\vfill
\newpage
\item $\ds f(x)=\sqrt{1+x^2}$ \vfill
\item $\ds f(x)=\frac{e^x}{\sqrt{x}}$\vfill
\item $\ds f(x) = \left( \ln(x^2+e^2)\right)^5$\vfill
\newpage
\item $\ds f(x) = \frac{x \ln(x)}{2}$ \vfill
\item $\ds f(x) = e^{\pi x+1}+\sqrt{3}\cot(\pi x)$ \vfill
\item Find $\ds \frac{dy}{dx}$ for $\ds 2x+y=\cos(xy)$. You must solve for $\ds \frac{dy}{dx}$. \vfill
