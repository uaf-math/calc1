...
\item   $\ds f(x)=\frac{1}{4x}+\sqrt{4x}$
\vfill

\item   $\ds f(x)=\frac{\sin(x)}{\cos(x)}$
\vfill


\newpage
%%% page 2
\item   $\ds f(x)=e^{(x^3-4x^2+7)}$
\vfill
\item   $\ds f(x)=\frac{\cos (x/2)}{2x^4}$
\vfill
...
\newpage
%%%page 3
\item   $\ds f(x)=\sqrt{x+\ln(3x)}$
\vfill

\item   $\ds f(x) = \frac{x \ln(x)}{\ln 3}$
\vfill

\item   $\ds y=\pi \left( \frac{1+x}{2} \right)^4$
\vfill
...
\newpage
%%%% page 4
\item   $\ds f(x) = \left(\cos(x^2+e^2)\right)^5$
\vfill

\item  $\ds f(x)=\tan^{-1}x$
\vfill

\item  Find $\ds \frac{dy}{dx}$ for $\ds 2x+y=y\sin(x)$. You must solve for $\ds \frac{dy}{dx}$.
\vfill
