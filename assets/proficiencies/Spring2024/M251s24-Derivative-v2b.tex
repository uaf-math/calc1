...
\begin{subproblems}
\item   $\ds f(x)=4 \sin^{-1}(3x^3)$
\vfill

\item
$\ds f(x)=3\sin(x)\cos(x)$
\vfill

\item   $\ds f(x)=\frac{\sqrt{x}}{5}-\frac{5}{\sqrt{x}}+\frac{\sqrt{3}}{4}$
\vfill
...
\newpage
\item  $\ds f(x) = \ln\left(\frac{x^2e^x}{12x} \right)$
\vfill

\item   $\ds f(x) = \frac{\sin(5)}{\sqrt[3]{\sin(x)}}$
\vfill
