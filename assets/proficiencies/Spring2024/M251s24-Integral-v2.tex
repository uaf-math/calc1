...
\item $\ds \int_1^4 \frac{x+1}{\sqrt{x}} \; dx$
\vfill

\item $\ds \int_0^{1/2} (6-\cos(\pi x))\; dx$
\vfill

\item $\ds \int (x+3)(5x+2)\; dx$
\vfill

\newpage

\item $\ds \int  xe^{9x^2}\; dx$
\vfill

\item $\ds \int \frac{\sin(x)-1}{\cos(x)+x}\; dx$
\vfill

\item $\ds \int \frac{e^x}{(12+e^x)^4}\; dx$
\vfill

\newpage

\item $\ds \int \sec(1-2x)\tan(1-2x) \; dx$
\vfill

\item $\ds \int \frac{8}{1+x^2} \; dx$
\vfill

\item $\ds \int x(x+1)^{10} \; dx$
\vfill

\newpage

\item $\ds \int \sqrt{2}\left(\sec(x)\right)^{2}\; dx$
\vfill

\item $\ds \int \left(\frac{1}{x}+\frac{\ln(x)}{x}\right)\; dx$
\vfill

\item $\ds \int \left(\sqrt[3]{x^5}+\sqrt[3]{4}\right)\; dx$
\vfill
