...
\item $\ds \int \left( \frac{x}{2}+\frac{2}{x} +\frac{2}{3}\right)\; dx$
\vfill
%easy u-sub for ln
\item $\ds \int \frac{1-\sin(2x)}{2x+\cos(2x)}\; dx$
\vfill
%thoughtful u-sub, power rule, 
%exact homework problems
\item $\ds \int \frac{5}{x(\ln x)^2}\; dx$
\vfill
...
\item $\ds \int \frac{x^3}{\sqrt{4-x^4}} \; dx$
\vfill
%no sub + u-sub
%e and trig
\item $\ds \int (e^{-x}+\sec^2(x)) \; dx$
\vfill
