...
\item   $\ds f(x)=\sqrt{5x-\ln(4x)}$
\vfill

\newpage

\item   $\ds f(x)=\frac{\sin(x/2)}{x^6}$
\vfill


\item   $\ds f(x)=\frac{1}{8x}+\sqrt{7-x}+9^4$
\vfill
...
%decimal exponent
\item   $\ds f(x) = \pi \sin\left(\frac{9+x}{12}\right)$
\vfill

\item  $\ds f(x) = (\cos(x^4+e^4))^2$
\vfill

\item  Find $\ds \frac{dy}{dx}$ for $\ds 2y-1 = ye^x-2x$. You must solve for $\ds \frac{dy}{dx}$.
\vfill
